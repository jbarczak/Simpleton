...
if not ITEM_NAME or 
   not ITEM_EXT  or 
   not ITEM_PATH then
    print("ARGS MUST BE: <item_name> <item_ext> <item_path>.  Make sure the file is in the project!")
    os.exit(0)
end

print("Josh's Boilerplate C++ generator");
print("ITEM_NAME=" .. ITEM_NAME )
print("ITEM_EXT=" .. ITEM_EXT )
...
DOXYGEN_GROUP   = "Simpleton"
NAMESPACE_NAME  = "Simpleton"    -- namespace declaration to generate.  Use nil for no namespace
FILE_PREFIX     = nil       -- Prefix on filenames.  Use nil for none
PROJECT_DESC    = "The lazy man's utility library"
AUTHOR          = "Joshua Barczak"
COPYRIGHT       = os.date("Copyright %Y Joshua Barczak")

LICENSE = "//   LICENSE:  See Doc\\License.txt for terms and conditions"
...
--===========================================================================================================
 function SourceFileComment()
    ...
    PutText("//")
  if NAMESPACE_NAME then
    PutText("//   Implementation of class: " .. NAMESPACE_NAME .. "::" .. GetClassName() );
  else
    PutText("//   Implementation of class: " .. GetClassName() );
  end
